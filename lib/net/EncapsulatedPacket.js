...
var EncapsulatedPacket = (function (_Packet) {
    _inherits(EncapsulatedPacket, _Packet);
    ...
    function EncapsulatedPacket() {
        ...
        _classCallCheck(this, EncapsulatedPacket);
    ...
    _createClass(EncapsulatedPacket, [{
        ...
        value: function getUnderlyingPackets() {
            return [_Packet3['default'].decode(this.data)];
        }
    }, {
        key: 'encode',
