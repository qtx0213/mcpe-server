...
defineProtocol(Protocol.CONNECTED_PING, {
  id: 0x01,
  reply: Protocol.UNCONNECTED_PING,
  fields: {
...
defineProtocol(Protocol.ID_UNCONNECTED_PING_OPEN_CONNECTIONS, {
  id: 0x1C,
  fields: {
    pingID: DataTypes.Long,
...
defineProtocol(Protocol.LOGIN_PACKET, {
  id: 0x82,
  fields: {
    clientID: DataTypes.Long,
...
defineProtocol(Protocol.CUST_0, {
  id: 0x80,
  fields: {
    count: DataTypes.ByteArray(3),
    payload: DataTypes.AckPayload
  }
});

defineProtocol(Protocol.CUST_1, {
  id: 0x81,
  fields: {
    count: DataTypes.ByteArray(3),
    payload: DataTypes.AckPayload
...
defineProtocol(Protocol.CUST_2, {
  id: 0x82,
  fields: {
    count: DataTypes.ByteArray(3),
    payload: DataTypes.AckPayload
...
defineProtocol(Protocol.CUST_3, {
  id: 0x83,
  fields: {
    count: DataTypes.ByteArray(3),
    payload: DataTypes.AckPayload
...
defineProtocol(Protocol.CUST_4, {
  id: 0x84,
  fields: {
    count: DataTypes.ByteArray(3),
    payload: DataTypes.AckPayload
...
defineProtocol(Protocol.CUST_5, {
  id: 0x85,
  fields: {
    count: DataTypes.ByteArray(3),
    payload: DataTypes.AckPayload
...
defineProtocol(Protocol.CUST_6, {
  id: 0x86,
  fields: {
    count: DataTypes.ByteArray(3),
    payload: DataTypes.AckPayload
...
defineProtocol(Protocol.CUST_7, {
  id: 0x87,
  fields: {
    count: DataTypes.ByteArray(3),
    payload: DataTypes.AckPayload
...
defineProtocol(Protocol.CUST_8, {
  id: 0x88,
  fields: {
    count: DataTypes.ByteArray(3),
    payload: DataTypes.AckPayload
...
defineProtocol(Protocol.CUST_9, {
  id: 0x89,
  fields: {
    count: DataTypes.ByteArray(3),
    payload: DataTypes.AckPayload
...
defineProtocol(Protocol.CUST_A, {
  id: 0x8A,
  fields: {
    count: DataTypes.ByteArray(3),
    payload: DataTypes.AckPayload
...
defineProtocol(Protocol.CUST_B, {
  id: 0x8B,
  fields: {
    count: DataTypes.ByteArray(3),
    payload: DataTypes.AckPayload
...
defineProtocol(Protocol.CUST_C, {
  id: 0x8C,
  fields: {
    count: DataTypes.ByteArray(3),
    payload: DataTypes.AckPayload
...
defineProtocol(Protocol.CUST_D, {
  id: 0x8D,
  fields: {
    count: DataTypes.ByteArray(3),
    payload: DataTypes.AckPayload
...
defineProtocol(Protocol.CUST_E, {
  id: 0x8E,
  fields: {
    count: DataTypes.ByteArray(3),
    payload: DataTypes.AckPayload
...
defineProtocol(Protocol.CUST_F, {
  id: 0x8F,
  fields: {
    count: DataTypes.ByteArray(3),
    payload: DataTypes.AckPayload
